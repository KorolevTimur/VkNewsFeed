...
final class NewsfeedCodeCell: UITableViewCell {
    ...
    private func overlayFourthLayerOnBottomViewViews() {
        ...
        helpInFouthLayer(view: sharesView, imageView: sharesImage, label: sharesLabel)
    ...
    private func overlayThirdLayerOnBottomView() {
        ...
        likesView.anchor(top: bottomView.topAnchor,
                         ...
                         bottom: nil,
                         trailing: nil,
                         size: CGSize(width: Constants.bottomViewViewWidth, height: Constants.bottomViewViewHight))
